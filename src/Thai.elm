port module Thai exposing (main)
...
view model =
  div []
    ...
    , div [style "font-weight" "bold", style "margin-top" "12px"] [ text "Get thai text :"]
    , div [ id "convert", dir "ltr"] [ text (Trans_Thai.transl model.content) ]
    ]
